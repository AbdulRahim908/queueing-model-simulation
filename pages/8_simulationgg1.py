...
def ServerUtilization(Server_util):
    ...
    st.pyplot()
def gg1(lembda,meu,sigma,ran_no):
...
df,s_no,arrival,service,WT,RT,TA,Server_util,avg_interarrival,avg_service,avg_TA,avg_WT,avg_RT=gg1(lembda,meu,sigma,ran_no)
st.write(df)
