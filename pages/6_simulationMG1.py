...
def ServerUtilization(Server_util):
    ...
    st.pyplot() 
def mg1(lembda,meuMin,meuMax,ran_no):
    meu=(meuMin+meuMax)/2
...
df,s_no,arrival,service,WT,RT,TA,Server_util,avg_interarrival,avg_service,avg_TA,avg_WT,avg_RT=mg1(lembda,meuMin,meuMax,ran_no)
st.write(df)
